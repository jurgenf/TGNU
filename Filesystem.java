...
public class Filesystem
{
    ...
    //De directories
    private static root = new Directory("/");
    private static Directory home = new Directory("home", filesystem);
    private static Directory userdir = new Directory(getUsername(), home);
    private static Directory mainframe = new Directory("mainframe", filesystem);
    ...
    private static home.addChild(userdir);
    private static filesystem.addChild(home);
    private static filesystem.addChild(mainframe);
    private static mainframe.addChild(mainframeEtc);
    private static mainframe.addChild(mainframeHome);
    private static mainframe.addChild(mainframeBin);
    private static mainframe.addChild(mainframeTmp);
    private static mainframe.addChild(mainframeVar);
    private static mainframeHome.addChild(earl);
    private static mainframeHome.addChild(thomas);
    private static mainframeHome.addChild(et);
    private static mainframeHome.addChild(henry); 
    private static mainframeVar.addChild(www);
